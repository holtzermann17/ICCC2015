...
subfields of $K/F$ extension and the subgroups of $\mathbf{Gal}(K)$;
...
means to be a root'' with ``what it means to be an automorphism.''
Indeed, the proof is in some sense the only thing it could be if one
knows these definitions.  
...
proof just a blend?  And is there anything special about this proof?
