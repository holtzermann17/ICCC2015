...
% \begin{verbatim}
% logic CASL
% %%PRIME IDEAS OVER PRINCIPAL IDEAL DOMAINS (PID) AS A BLEND
...
% %%axioms for PID-s
% %%every ideal is generated by an element
% pred __generates__: RingElt * Ideal 
...
% . (a isIn A /\ b isIn B) => a*b isIn A**B)
% => A**B issubsetOf D
% end
...
% forall A : Generic . exists a : RingElt . a generates A
%  %(Ax15)%
