...
%
  \draw[thick] (8.75,0) node[below={2cm},align=center] {\emph{B.~how to become a writer*}\\{[}*: According to \citep{king2000writing}.]}
...
%
  \draw[thick] (13,0) node[below={2cm}] {\emph{C.~dual-purpose}}
  ...
  \draw[thick] (4,-5.5) node[below={2.2cm}] {\emph{D.~learning by doing}}
                        ...
                        pic[red, -latex]{uarc=330:450:1.5cm:Situation:Speaks:1cm:.1cm};
%
%
  \draw[thick] (8.75,-5.5) node[below={2.2cm}] {\emph{E.~workshop}}
                        pic[red, -latex]{darc=100:180:1.7cm:Poet:Write:1.5cm:1.5cm}
                        pic[red, -latex]{rarc=190:270:1.7cm:Poem:Responds:1cm:.8cm}
                        pic[red, -latex]{rarc=280:360:1.7cm:Situation:Speaks:1cm:1.4cm}
                        pic[red, -latex]{larc=370:450:1.7cm:Critic:Respond:1.4cm:.2cm};
