...
\mathbb{N}&&\leftarrow_{\phi(G,\SIdIndex{NAT})}&&\sigma&&\rightarrow_{\phi(G,\SIdIndex{FUNC})}&&X
\end{align}
...
which is consistent.  An algorithm for computing all maximally
consistent blends achievable by weakeking by omitting axioms,
in the case where consistency of the theories can be determined,
is given in \textcite{MartinezEtAl14}.
...
\end{eqnarray*}
Finding these axioms is an example of running the blend, and from which it
...
The code for the implemented examples is this paper
is available on-line.%
\footnote{See: \texttt{\url{https://github.com/ewenmaclean/ICCC_hetsfiles}}}
